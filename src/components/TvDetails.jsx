 ...
 flex items-center justify-center rounded-full "
    ...
    `,    
        ...
        {/* right */}
          <div className="w-[70%]  h-full">
            ...
            <div className="text-zinc-100 leading-none pt-[10vh]">
              ...
              <div className="flex text-lg font-semibold mt-2 items-center gap-3">
                <p className="flex items-center">
                  {" "}
                  <span className="mr-2 text-xs flex items-center rounded justify-center border-zinc-100 border-1 text-white ">
                    UA
                  </span>
      ...
      {/* seasons */}
          ...
          <h1 className="text-2xl p-5 mb-3 font-semibold  text-zinc-200">{info.detail.seasons.length>0  && "Seasons"}</h1>
       <div className="px-5 overflow-y-hidden  flex gap-5 w-full ">
           {
        info.detail.seasons.map((item,idx)=>(
          <div key={idx} className="w-[15vw] bg-zinc-800   h-[50vh] flex flex-col justify-center items-center rounded ">
            <img 
            className="min-w-[13vw] m-5 h-[18vw]  object-cover"
            src={`https://image.tmdb.org/t/p/original/${item.poster_path}`}
             alt="" />
             <h1 className="text-xl text-zinc-300 mb-2 font-semibold">
       ...
       <div className="px-2 mb-10  w-full ">
          <h1 className="text-2xl p-5 mb-3 font-semibold  text-zinc-200">{info.recommendations.length > 0? "Recommendations" : "Similar"}</h1>
